...
import { AfterViewInit, ElementRef, Inject, Injectable, QueryList } from "@angular/core";
...
export class TableHandler 
{
    ...
    protected extracted_FilteredData:SecInqDataModel[] = this.getApiExtractedData;
...
//#endregion
  ...
  updatePageTransition()
  {
    ...
    this.segmentData();
    //this.__removeActiveClassButton(paginationButtons);
  }
  //#endregion
...
//#region 
     ...
     * @param page 
     */
    __transitionToSpecificPage(page:number, event:any)
    {
   ...
   /* __removeActiveClassButton(event:any)
    {
